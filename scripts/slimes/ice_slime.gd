...
# This script only adds ice slime burst shooting behavior
...
func _ready() -> void:
	...
	# tiny random offset so groups of ice slimes don’t fire in perfect sync
