...
const UPGRADE_DEFS: Array = [
	...
	{"id": "primary_damage_up_1", "text": "Hollow Point Rounds (+20% Primary Damage)", "rarity": Rarity.UNCOMMON, "price": 180, "category": "primary", "pool": "shop", "icon_path": "", "effect": "primary_damage_mult", "primary_damage_mult": 1.20, "enabled": true},
	{"id": "primary_firerate_up_1", "text": "Rapid Trigger (+20% Primary Fire Rate)", "rarity": Rarity.UNCOMMON, "price": 180, "category": "primary", "pool": "shop", "icon_path": "", "effect": "primary_fire_rate_mult", "primary_fire_rate_mult": 1.20, "enabled": true},
	...
	{"id": "primary_barrel_speed", "text": "Reinforced Barrel (Bullets Travel Faster)", "rarity": Rarity.EPIC, "price": 500, "category": "primary", "pool": "shop", "icon_path": "", "effect": "primary_bullet_speed_mult", "primary_bullet_speed_mult": 1.30, "enabled": true},
	...
	{"id": "primary_steady_aim", "text": "Steady Aim (+30% Damage While Stationary)", "rarity": Rarity.RARE, "price": 340, "category": "primary", "pool": "shop", "icon_path": "", "effect": "primary_stationary_damage_mult", "primary_stationary_damage_mult": 1.30, "enabled": true},
	{"id": "primary_twinshot_burst", "text": "Twinshot Burst (+1 Bullet, 0.06s Delay)", "rarity": Rarity.EPIC, "price": 600, "category": "primary", "pool": "shop", "icon_path": "", "effect": "primary_burst", "primary_burst_count_add": 1, "primary_burst_delay": 0.06, "enabled": true},
