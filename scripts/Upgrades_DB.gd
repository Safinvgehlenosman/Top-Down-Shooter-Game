...
const UPGRADE_DEFS: Array = [
	...
	{"id": "shuriken_seeking_chain", "text": "Seeking Chain (Shuriken)", "rarity": Rarity.EPIC, "price": 650, "category": "alt", "pool": "shop", "icon_path": "", "effect": "shuriken_seeking_chain", "shuriken_seek_add": 1, "requires_weapon": "shuriken", "stackable": true, "enabled": true, "description": "After hitting an enemy, shurikens seek another nearby enemy for 50% damage. Stackable."},
	...
	# --- DASH UPGRADES ---
	{"id": "dash_distance_up_1", "text": "Fleetfoot I (+20% Dash Distance)", "rarity": Rarity.COMMON, "price": 120, "category": "ability", "pool": "shop", "icon_path": "", "effect": "dash_distance", "enabled": true, "stackable": true},
	{"id": "dash_distance_up_2", "text": "Fleetfoot II (+40% Dash Distance)", "rarity": Rarity.UNCOMMON, "price": 240, "category": "ability", "pool": "shop", "icon_path": "", "effect": "dash_distance", "enabled": true, "stackable": true},
	{"id": "dash_cooldown_up_1", "text": "Swift Recovery I (-10% Dash Cooldown)", "rarity": Rarity.COMMON, "price": 110, "category": "ability", "pool": "shop", "icon_path": "", "effect": "dash_cooldown", "enabled": true, "stackable": true},
	{"id": "dash_cooldown_up_2", "text": "Swift Recovery II (-20% Dash Cooldown)", "rarity": Rarity.UNCOMMON, "price": 220, "category": "ability", "pool": "shop", "icon_path": "", "effect": "dash_cooldown", "enabled": true, "stackable": true},
	{"id": "dash_executioner", "text": "Executioner (Dash)", "rarity": Rarity.RARE, "price": 380, "category": "ability", "pool": "shop", "icon_path": "", "effect": "dash_executioner", "enabled": true, "stackable": false, "requires_ability": "dash", "description": "On kill, reduce dash cooldown by 0.75s."},
